...
const FALLBACK_COURSES: FeaturedCourse[] = [
  ...
  },
  {
    ...
    image_url: 'https://images.pexels.com/photos/256395/pexels-photo-256395.jpeg?auto=compress&cs=tinysrgb&w=800',
    order_index: 4,
  },
  {
    id: '6',
    ...
    image_url: 'https://images.pexels.com/photos/1389429/pexels-photo-1389429.jpeg?auto=compress&cs=tinysrgb&w=800',
    order_index: 5,
  },
];
...
export default function HomePage() {
  ...
  const loadFeaturedCourses = async () => {
    const { data } = await supabase
      ...
      .select('id, title, description, category, instructor, image_url, order_index')
      .eq('is_active', true)
      .order('order_index');
                ...
                >
                  ...
                  <div className="p-6">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <Link
                        to="/login"
                        className="hidden px-4 py-2 bg-teal-600 text-white rounded-lg hover:bg-teal-700 transition-colors text-sm font-semibold"
                      >
                        {t('viewCourse')}
                      </Link>
                    </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
              <div>
                <div className="flex items-center space-x-2 mb-4">
                  <KeyKursLogo className="w-10 h-10" />
                  <span className="text-xl font-bold text-white">KeyKurs</span>
                </div>
